...
for f in range(1, 5):
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (
                ...
                if dice_val > dice_val_best:
                    ...
                    torch.save(
                        model.state_dict(), os.path.join(root_dir, f"best_metric_attention_unet_model_f{f}.pth")
                    )
                    print(
    ...
    #     )
    # model.load_state_dict(torch.load(os.path.join(root_dir, f"best_metric_attention_unet_model_f{f}.pth")))
