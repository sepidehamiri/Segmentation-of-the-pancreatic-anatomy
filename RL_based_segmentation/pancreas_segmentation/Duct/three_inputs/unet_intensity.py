...
#                    torch.save(
#                        model.state_dict(), os.path.join(root_dir, f"best_metric_duct_unet_model_f{f}.pth")
#                    )
#                    print(
...
#        )
#    model.load_state_dict(torch.load(os.path.join(root_dir, #f"best_metric_duct_unet_model_f{f}.pth")))
