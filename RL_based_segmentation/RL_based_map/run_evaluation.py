...
if __name__ == "__main__":
    ...
    for f in args.model_files:
        ...
        environment = get_player(files_list=files, landmark_ids=landmarks, viz=0, task="eval", file_type=file_type,
                                 saveGif=False, saveVideo=False, agents=agents, logger=logger)
